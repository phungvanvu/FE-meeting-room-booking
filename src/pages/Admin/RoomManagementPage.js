...
const RoomManagement = () => {
  ...
  const rooms = [
    ...
    },
    {
      ...
      capacity: 6,
      status: 'Tạm dừng',
      location: 'Thành Công Building',
      devices: ['Video', 'White Board'],
    ...
    },
    {
      ...
      capacity: 10,
      status: 'Sử dụng',
      location: 'The West Building',
      devices: ['Sound System', 'Audio'],
      ...
      <div className='fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50'>
        <div className='bg-white shadow-lg p-6 rounded-lg w-[800px]'>
          <div className='flex justify-between mb-4'>
            <h3 className='text-xl font-semibold text-blue-700 text-center flex-1'>
              Danh sách đặt phòng
            </h3>
            <button onClick={closeBookingForm} className='text-red-500'>
              X
            </button>
          </div>
          <div className='flex mb-4'>
            ...
            />
            <button className='ml-2 p-2 bg-blue-500 text-white rounded hover:bg-blue-700'>
              Download
            </button>
          </div>
              ...
              {bookings.map((booking, index) => (
                <tr key={index}>
                  ...
                  <td className='border border-gray-300 p-2 text-center'>
                    ...
                    >
                      {' '}
                      &#10006; {/* Ký tự Unicode cho hình thập tự */}{' '}
                    </button>
                  </td>
                </tr>
              ))}
            ...
            <div className='bg-white shadow-lg p-6 rounded-lg'>
              ...
              <div className='flex justify-center gap-4 mt-4'>
                <button
                  ...
                  className='p-2 border border-blue-500 text-blue-500 rounded hover:bg-blue-500 hover:text-white'
                >
                  Xóa
                </button>
                <button
                  onClick={cancelDeleteBooking}
                  className='p-2 border border-gray-500 text-gray-500 rounded hover:bg-gray-500 hover:text-white'
                >
                  Hủy
                </button>
              </div>
        ...
        <div className='bg-white shadow-lg p-6 rounded-lg w-[600px]'>
          ...
          <div className='grid gap-0.5 text-gray-700'>
            ...
            <div className='grid grid-cols-2 gap-2'>
              {['Audio', 'HDMI', 'Video', 'White Board', 'Sound System'].map(
                (device) => (
          ...
          <div className='flex gap-2 mt-4'>
            <button
              ...
              className='flex-1 p-2 bg-white border border-blue-500 text-blue-500 rounded hover:bg-blue-500 hover:text-white'
            >
              {' '}
              Lưu
            </button>
            <button
              onClick={onCancel}
              className='flex-1 p-2 bg-white border border-red-500 text-red-500 rounded hover:bg-red-500 hover:text-white'
            >
              Hủy
            </button>
          </div>
  ...
  const handleSearch = () => {
    const result = rooms.filter((room) => {
      ...
      return (
        matchesSearch && matchesLocation && matchesCapacity && matchesStatus
      );
    });
  ...
  ); // Danh sách phòng hiện tại cho trang
              ...
              <input
                ...
                onChange={() =>
                  setSelectedCapacities((prev) =>
                    prev.includes(capacity.toString())
                      ? prev.filter((c) => c !== capacity.toString())
                      : [...prev, capacity.toString()],
                  )
                }
              />
          ...
          {currentRooms.map((room) => (
            ...
            >
              ...
              <div className='grid grid-cols-2 gap-1 text-gray-700'>
                ...
                <span>{room.devices.join(', ')}</span>
              </div>
              <div className='flex gap-2 mt-4'>
                <button
                  onClick={() => handleEditRoom(room)}
                  className='flex-1 p-2 bg-white border border-blue-700 text-blue-700 rounded hover:bg-blue-700 hover:text-white'
                >
                  Sửa
                </button>
                <button
          ...
          <div className='bg-white shadow-lg p-6 rounded-lg'>
            ...
            <div className='flex justify-center gap-4 mt-4'>
              <button
                ...
                className='p-2 bg-white border border-red-500 text-red-500 rounded hover:bg-red-500 hover:text-white'
              >
                Xóa
              </button>
              <button
                onClick={cancelDeleteRoom}
                className='p-2 bg-white border border-gray-500 text-gray-500 rounded hover:bg-gray-500 hover:text-white'
              >
                Hủy
              </button>
            </div>
